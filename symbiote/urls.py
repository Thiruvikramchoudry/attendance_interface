...
urlpatterns = [
    ...
    path('employee_details/<str:username>',views.employee_detail,name="employee_details"),
    path('attendance_status/<str:username>',views.attendance_status,name="attendance_status"),
    ...
    path('supervisor_page/<str:username>',views.main,name="supervisor_page"),
