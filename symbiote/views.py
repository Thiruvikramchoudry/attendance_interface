...
def main(request):
    ...
    return render(request, 'symbiote/index.html',{'username': request.user, 'employee_count': employee_count, 'present_count': status, 'details': details})
...
def admin_page(request):
    ...
    return render(request,'symbiote/admin_page.html',{"username":request.user,'supervisor_count':supervisor_count,'project_count':project_count,'employee_required':employee_count-employee_required,'total_employee':employee_count,'projects':projects})
